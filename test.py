...
grp = tp.TitleBox("chuj kurwa", children=elements)
print(grp.get_min_size())
# grp = tp.TitleBox("chuj kurwa")
grp.center_on(screen)
# grp.finish()
# grp.re move_all_children()
# grp.set_size((200, 20))
# a = grp.get_blit_rects()
# grp.clip_children()
# grp.clamp()
# grp.update_iframe()
# grp.refresh_resizer_size()
# grp.resi
